...
-- 6
-- Formula?i �n limbaj natural o problem? pe care s? o rezolva?i folosind un subprogram stocat independent 
...
-- 8
-- Formula?i �n limbaj natural o problem? pe care s? o rezolva?i folosind un subprogram stocat independent de tip func?ie
-- care s? utilizeze �ntr-o singur? comand? SQL 3 dintre tabelele definite. Defini?i minim 2 excep?ii proprii. 
-- Apela?i subprogramul astfel �nc�t s? eviden?ia?i toate cazurile definite ?i tratate.
...
-- 9
-- Formula?i �n limbaj natural o problem? pe care s? o rezolva?i folosind un subprogram stocat independent 
-- de tip procedur? care s? utilizeze �ntr-o singur? comand? SQL 5 dintre tabelele definite. 
-- Trata?i toate excep?iile care pot ap?rea, incluz�nd excep?iile NO_DATA_FOUND ?i TOO_MANY_ROWS. 
-- Apela?i subprogramul astfel �nc�t s? eviden?ia?i toate cazurile tratate.
...
-- 13
-- Defini?i un pachet care s? con?in? toate obiectele definite �n cadrul proiectului.
